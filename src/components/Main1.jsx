...
import profileImage from '../assets/profile.jpg'; // Correct the relative path based on your structure


export default function Main1() {
    return (
        <div className='main'>
            <img className="profile" src={profileImage} alt="Profile" /> {/* Use the imported image */}
